...
More info at @.agent/python-mcp-server.instructions.md
Architecture at @.agent/architecture.instructions.md
All documentation is mandatory to save in docs/**/*.md

...
class GoogleCalendarOAuthHandler:
    """Handles OAuth2 authentication for Google Calendar API with multi-account support."""
    ...
    def __init__(
        ...
        Args:
            ...
            scopes: Google Calendar API scopes to request
        """
    ...
    def get_credentials(self) -> Credentials:
        ...
        if not self._creds or not self._creds.valid:
            if self._creds and self._creds.expired and self._creds.refresh_token:
                ...
                print(f"\nAuthenticating Google Calendar account: {self.account_id}")
    ...
    def list_authenticated_accounts(tokens_dir: Optional[Path] = None) -> list[str]:
        ...
        """
        tokens_dir = tokens_dir or settings.google_calendar_tokens_dir
